...
class AniyomiMPVView(context: Context, attributes: AttributeSet) : BaseMPVView(context, attributes) {
    ...
    private val observedProps = mapOf(
        ...
        "user-data/playon/show_text" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/toggle_ui" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/show_panel" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/software_keyboard" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/set_button_title" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/reset_button_title" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/toggle_button" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/switch_episode" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/pause" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/seek_by" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/seek_to" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/seek_by_with_text" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/seek_to_with_text" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
        "user-data/playon/launch_int_picker" to MPVLib.mpvFormat.MPV_FORMAT_STRING,
